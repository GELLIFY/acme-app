  ...
  return (
    <section>
      ...
      <p>
        ...
        <Link href="https://github.com/leerob/next-self-host/blob/main/image-loader.ts">
          here
        </Link>
        , which you can enable through{" "}
        <Link href="https://github.com/leerob/next-self-host/blob/main/next.config.ts">
      ...
      <p>
        <Link href="/protected">View the demo</Link>
      </p>
      <p>
        <Link href="https://nextjs.org/docs/app/building-your-application/deploying#middleware">
          Read the docs
        </Link>
      </p>
      ...
      <p>
        <Link href="https://nextjs.org/docs/app/building-your-application/optimizing/instrumentation">
          Read the docs
        </Link>
      </p>
      ...
      <p>
        <Link href="https://nextjs.org/docs/app/building-your-application/deploying#environment-variables">
          Read the docs
        </Link>
      </p>
    </section>
