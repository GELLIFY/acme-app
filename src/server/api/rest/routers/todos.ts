...
app.openapi(
  ...
  async (c) => {
    ...
    return c.json(validateResponse({ data: result }, todosSchema));
  },
);
...
app.openapi(
  ...
  async (c) => {
    ...
    return c.json(validateResponse(result, todoSchema));
  },
);
...
app.openapi(
  ...
  async (c) => {
    ...
    return c.json(validateResponse(result[0], todoSchema));
  },
);
